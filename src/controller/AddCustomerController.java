...
public class AddCustomerController implements Initializable {
    ...
    @FXML private TextField customer_Postalcode;
    ...
    /**
     * This handles saving the customer using the form fields.
     * @param event This will save the customer to the database.
     */
    public void saveCustomerButton(ActionEvent event)
    {
        try{
            //int id = customer.getCustomer_ID();
            String name = customer_Name.getText();
            String address = customer_Address.getText();
            String postalcode = customer_Postalcode.getText();
            ...
            if (error == false)
            {
                ...
                CustomerDAO.newCustomer( name, address, postalcode, phone, created_By, last_Updated_By, div);
                firstLevelDivisions.clear();
                countries.clear();
                Parent customerScreenParent = FXMLLoader.load(getClass().getResource("CustomerScreen.fxml"));
                Scene customerScreenScene = new Scene(customerScreenParent);

                //This line gets the Stage info
                Stage window = (Stage)((Node)event.getSource()).getScene().getWindow();

                window.setScene(customerScreenScene);
    ...
    /**
     * This will cancel the add customer stage and return to the customer stage.
     * @param event This will send the user back to the customer page.
     * @throws IOException 
     */
    ...
    /**
     * This will find the country for the selected customer.
     * @param event Finds the country for the selected customer.
     */
    ...
    /**
     * Initializes the controller class and the combo boxes.
     */
    @Override
